...
<html>
  <body>
    ...
    <div class="container">
      <div class="pt-2 border-top border-dark border-3 my-1"></div>
    </div>
    <h2 class="fw-bold pt-3 pb-1 text-uppercase text-center">Evolution de l'entreprise *</h2>
    <br>
    <div class="horizontal-timeline">
      ...
      <div class="horizontal-timeline">
        <img src="images\route-10.png" alt="Route" class="position-absolute w-100" style="height: 6%; left: 0%">
      ...
      <section>
        ...
        <div class="d-flex justify-content-center">
          <img src="images\cupra1.png" alt="Cupra" class="w-100">
        </div>
        <div class="container">
          <hr>
          <div class="row">
