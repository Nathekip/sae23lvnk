                         ...
                         <div class="container-fluid text-center py-3 d-flex justify-content-between align-items-center bg-white">
                            ...
                            <div class="login-form">
                              <form action="NUMERODEPAGE.php" id="login-form" method="post">
                                ...
                                <a href="page03.php"><button type="submit" name="page" value=NUMERODEPAGE class="btn btn-success data-bs-toggle="modal" data-bs-target="#myModal"">Se connecter</button></a>
                              </form>
