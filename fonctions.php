...
function pagenavbar($page=""){
  ...
  if ( isset($_SESSION['utilisateur']) ){
	  $navbar .= '<li class="nav-item">
	       	       <a class="nav-link" data-bs-toggle="tooltip" data-bs-placement="bottom" title="User" href="Monprofil7.php"><img class="border border-2 border-white rounded-circle circle border" width="36" height="36" src="pp/Kono.jpeg" alt="PP Kono"></i></a>
		     </li>';
